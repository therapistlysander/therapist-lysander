...
class BookingController extends Controller
{
    ...
    public function storePreIntake(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'preferred_language'    => ['nullable', 'string', 'in:nl,en'],
            'presenting_issue'      => ['nullable', 'string', 'max:3000'],
            'brings_to_therapy'     => ['nullable', 'string', 'max:3000'],
            'support_areas'         => ['nullable', 'array'],
            'support_areas.*'       => ['string', 'max:100'],
            'communication_style'   => ['nullable', 'string', 'max:100'],
            'duration_expectation'  => ['nullable', 'string', 'max:100'],
