...
return [
    ...
    */
    'footer' => [
        ...
        'service_locations' => '📍 Amsterdam & Online',
    ...
    */
    'page_title' => [
        ...
        'testimonials' => 'Cliëntervaringen | Therapist Lysander',
    ...
    */
    'home' => [
        'who_i_am_label'        => 'Wie ik ben',
        'what_i_work_with'      => 'Waar ik mee werk',
        'therapy_approach_label' => 'Therapieaanpak',
        'therapy_with_me'       => 'Hoe Therapie Bij Mij Is',
        'therapy_desc'          => 'Therapie bij mij is warm, direct en praktisch. Samen verkennen we de patronen die je vasthouden, verwerken we moeilijke emoties, en bouwen we een leven dat beter past bij wie je werkelijk bent.',
        'safe_title'            => 'Veilig en oordeelvrij',
        'safe_desc'             => 'Een ruimte waar je open kunt spreken, zonder angst voor oordeel of druk om te presteren.',
        'evidence_title'        => 'Evidence-based en praktisch',
        'evidence_desc'         => 'Gegrond in bewezen therapeutische methoden, toegepast op een manier die past bij jouw leven.',
        ...
        'step_intake_title'     => 'Kennismakingsgesprek',
        'step_intake_desc'      => 'Een uitgebreid kennismakingsgesprek van 60 minuten waarin we je achtergrond, huidige uitdagingen, relevante levenservaringen en behandelingsdoelen verkennen. Na het kennismakingsgesprek ontvang je een persoonlijk behandelplan.',
    ...
    */
    'about' => [
        'page_title'            => 'Over Lysander Verschuur, MSc. | Psychotherapie & Traumatherapie',
        'meta_description'      => 'Maak kennis met Lysander Verschuur, MSc. — een opgeleide psycholoog en traumasppecialist die werkt met CGT, ACT, EMDR, Schematherapie en lichaamsgerichte benaderingen. Online sessies wereldwijd beschikbaar.',
        'who_i_am'              => 'Wie ik ben',
        'personal_journey'      => 'Persoonlijk pad',
        'how_i_work'            => 'Hoe ik werk',
        'my_approach'           => 'Mijn aanpak',
        'method_cbt'            => 'CGT',
        'method_act'            => 'ACT',
        'method_emdr'           => 'EMDR',
        'method_schema'         => 'Schematherapie',
        'method_somatic'        => 'Lichaamsgericht',
    ],
    ...
    */
    'fees' => [
        ...
        'process_intake_title'  => 'Kennismakingsgesprek',
        'process_intake_desc'   => 'Een uitgebreid gesprek waarin we je achtergrond, huidige uitdagingen, relevante levenservaringen en behandelingsdoelen verkennen. Voorafgaand aan de sessie vul je een vragenlijst in die het kennismakingsgesprek helpt sturen. Na het kennismakingsgesprek ontvang je een persoonlijk behandelplan met de belangrijkste uitdagingen, therapeutische doelen en voorgestelde aanpak.',
    ...
    */
    'contact' => [
        ...
        'whatsapp_desc'         => 'Stuur gerust een WhatsApp-bericht voor korte vragen of praktische zaken. Berichten worden beantwoord op werkdagen naargelang de beschikbaarheid.',
        'whatsapp_preferred'    => 'Liever een kort bericht?',
        'email_label'           => 'E-mail',
        'online_sessions'       => 'Sessievorm',
        'online_sessions_value' => 'Online wereldwijd of in mijn praktijk in Amsterdam',
        'session_duration'      => 'Sessieduur',
        'session_duration_value'=> '60 minuten · Gratis kennismakingsgesprek (30 min)',
        'languages'             => 'Talen',
        ...
        'captcha_label'         => 'Korte controle: wat is :a + :b?',
        'captcha_placeholder'   => 'Jouw antwoord',
        'captcha_failed'        => 'Dat antwoord was onjuist. Probeer het opnieuw.',
    ],
    ...
    */
    'faq' => [
        ...
        'cat_starting_therapy'  => 'Kennismaking & Start',
    ...
    */
    'booking' => [
        ...
        'what_brings_you'       => 'Wat brengt je hier vandaag?',
        'what_brings_desc'      => 'Een paar zinnen zijn voldoende. Waar worstel je momenteel mee, en waar zou je hulp bij willen? Dit helpt ons eerste gesprek richting te geven.',
        'goals_placeholder'     => 'Ik zou me graag meer willen voelen... / Ik worstel met...',
        'optional_helper'       => 'Dit is optioneel. Je kunt dit ook tijdens het gesprek zelf bespreken.',
        'choose_time'           => 'Kies een datum en tijd',
        'choose_time_desc'      => 'Selecteer een dag om de beschikbare tijden te zien. Zie je geen geschikt tijdstip? Neem gerust contact met me op.',
        ...
        'no_slots'              => 'Geen beschikbare tijden voor deze datum.',
        'load_error'            => 'Beschikbaarheid laden mislukt. Probeer het opnieuw.',
        'loading'               => 'Laden...',
        'toast_name_email'      => 'Vul je naam en e-mailadres in voordat je doorgaat.',
        'toast_valid_email'     => 'Vul een geldig e-mailadres in.',
        'toast_select_time'     => 'Selecteer een datum en tijd.',
