...
<div class="highlight-box">
    <table style="width:100%;border-collapse:collapse;">
        <tr>
            ...
            <td style="padding:4px 0;color:#1a2332;">{{ \Carbon\Carbon::parse($scheduledAt)->locale('nl')->isoFormat('dddd, j MMMM YYYY [om] HH:mm') }}</td>
        </tr>
    </table>
</div>
...
<div class="highlight-box">
    <table style="width:100%;border-collapse:collapse;">
        <tr>
            ...
            <td style="padding:4px 0;color:#1a2332;">{{ \Carbon\Carbon::parse($preferredDate)->locale('nl')->isoFormat('dddd, j MMMM YYYY') }}</td>
        </tr>
    </table>
</div>
@endif
