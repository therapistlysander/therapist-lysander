...
@section('title', optional($seo)->meta_title ?: ($isNl ? 'Algemene voorwaarden' : 'Terms & Conditions'))
...
<div class="page-hero">
  <div class="container--narrow">
    ...
    <h1 class="page-hero__title">{{ $content['title'] ?? ($isNl ? 'Algemene voorwaarden' : 'Terms & Conditions') }}</h1>
