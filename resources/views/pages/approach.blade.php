...
<style>
  ...
  .treatment-approach p { font-size: var(--size-base); color: var(--color-text-muted); line-height: 1.7; }
</style>
@endsection
    ...
    <div class="container">
      <div class="grid-2 fade-in">
        <div>
          ...
          <div class="divider"></div>
          <div style="color:rgba(255,255,255,0.75);font-size:var(--size-base);line-height:1.85;margin-bottom:var(--space-4);">
