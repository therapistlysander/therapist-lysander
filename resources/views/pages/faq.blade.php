      ...
      <div class="faq-page-grid">
        ...
        <div>
          ...
          <div class="faq-cta fade-in">
            <div>
              <h3>{{ $ctaSec?->content['heading'] ?? __('ui.faq.still_questions') }}</h3>
              <p>{!! $ctaSec?->content['body'] ?? __('ui.faq.still_questions_desc') !!}</p>
            </div>
            <a href="{{ $ctaSec?->content['cta_url'] ?? route('contact') }}" class="btn btn--primary btn--lg" style="white-space:nowrap;">
              {{ $ctaSec?->content['cta_label'] ?? __('ui.common.contact_me') }}
